...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get sleepHelp =>
      '<p>Baseline не отслеживает стадии сна и не предлагает анализ — он просто просит вас замечать, когда вы спите и сколько. Внимательное отношение к продолжительности собственного сна — это первый шаг к лучшему отдыху.</p><p><i>Подробная информация о сне будет добавлена позже.</i></p>';
