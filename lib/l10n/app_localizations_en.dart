...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get groundingHelp =>
      '<p>Grounding is a single tap. It shows a simple present-moment phrase - \"You\'re here\", \"One step at a time\", or similar. The button reappears after a short time; you can press it as many times a day as you want.</p><h3 style=\'margin-top:20px;margin-bottom:12px\'>Why might this help?</h3><p>Two lines of research offer indirect support.</p><p><b>Hypothesis 1 - Disrupting idle negative thinking</b></p><p>Many people find being alone with their thoughts so unpleasant that they prefer to administer electric shocks to themselves rather than sit quietly for 6-15 minutes <a href=\'#ref-1\'>[1]</a>. A minimal, low-effort action - like tapping a button - may <b>break the state of passive rumination or boredom</b>, providing a simple anchor.</p><p><b>Hypothesis 2 - Cueing present-moment awareness</b></p><p>Mindfulness- and acceptance-based interventions have a small, significant effect on improving affect intolerance/sensitivity (i.e., <b>ability to tolerate emotional states</b>) from pre- to post-intervention, with effects maintained up to 6 months <a href=\'#ref-2\'>[2]</a>. A single self-initiated cue to the present moment may briefly reduce worry or rumination.</p>';
